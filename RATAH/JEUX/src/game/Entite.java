...
public class Entite implements Serializable{
    ...
    Point hospitalLocationCivilization1 = new Point(325, 200);
    Point hospitalLocationCivilization2 = new Point(700, 450);
    ...
    public boolean isAtHospital(List<Entite> listePersonne) {
    	for(Entite entite : listePersonne) {
        if (this.getCivilisation().equals(entite.getCivilisation())) {
            return this.getPosition().equals(hospitalLocationCivilization1);
        } else {
            return this.getPosition().equals(hospitalLocationCivilization2);
        }
    	}
    	return true;
    }
    ...
    public void moveToHospital() {
        // Déplacer l'entité à l'hôpital en fonction de sa civilisation
        if (this.getCivilisation().equals(this.getCivilisation())) {
            setPosition(hospitalLocationCivilization1);
        } else {
            setPosition(hospitalLocationCivilization2);
        }
    }
